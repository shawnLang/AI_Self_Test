...
class TaskItem(SQLModel, table=True):
    ...
    llm_state: Optional[str] = Field(default=None, description="大模型状态")
    ...
    confirm_state: Optional[str] = Field(default=None, description="确认状态")
    confirmed_at: Optional[datetime] = Field(default=None, description="确认时间")
    remote_state: Optional[str] = Field(default=None, description="远端提交状态")
    ...
    train_state: Optional[str] = Field(default=None, description="提交训练状态")
