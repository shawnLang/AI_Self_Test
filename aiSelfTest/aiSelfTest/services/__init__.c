...
{
    "distutils": {
        "name": "aiSelfTest.services.__init__",
        "sources": [
            "aiSelfTest/services/__init__.py"
        ]
    },
    "module_name": "aiSelfTest.services.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__aiSelfTest__services
#define __PYX_HAVE_API__aiSelfTest__services
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "aiSelfTest.services" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "aiSelfTest.services.__init__"
extern int __pyx_module_is_main_aiSelfTest__services____init__;
int __pyx_module_is_main_aiSelfTest__services____init__ = 0;

/* Implementation of "aiSelfTest.services" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_[] = "\346\234\215\345\212\241\345\261\202\346\250\241\345\235\227\343\200\202";
/* #### Code section: decls ### */
...
#define __pyx_kp_u_aiSelfTest_services___init __pyx_string_tab[1]
...
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_services(); }
#endif
...
__Pyx_RefNannySetupContext("PyInit_services", 0);
  ...
  if (__pyx_module_is_main_aiSelfTest__services____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_aiSelfTest_services___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "aiSelfTest.services")) {
      if (unlikely((PyDict_SetItemString(modules, "aiSelfTest.services", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "aiSelfTest/services/__init__.py":1
 * """"""             # <<<<<<<<<<<<<<
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init aiSelfTest.services", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init aiSelfTest.services");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{28},{18},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (85 bytes) */
const char* const cstring = "x\332%\214\301\r\2000\014\0037\352\n\014\001\177+\024W\212H\213\240)\363\023\300\037\337}n\022\235iea\367\324y\335\232\331\023\240M\035\310\246\215\301\360K2W\311;P%<V\217m\030_jR\277?\207\330\317\235\276\261\310\260hx\224\201\0074\013(\341";
    PyObject *data = __Pyx_DecompressString(cstring, 85, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (103 bytes) */
const char* const bytes = "?aiSelfTest.services.__init__cline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
