...
def list_multimodal_models_route(
    ...
    logger.info("API 请求：查询多模态模型配置列表")
...
def create_multimodal_model_route(
    ...
    logger.info("API 请求：创建多模态模型配置 model_name={}", payload.model_name)
    return ApiResponse(
        code=0,
        message="success",
...
def update_multimodal_model_route(
    ...
    logger.info("API 请求：更新多模态模型配置 model_id={} model_name={}", model_id, payload.model_name)
    return ApiResponse(
        code=0,
        message="success",
...
def delete_multimodal_model_route(
    ...
    logger.info("API 请求：删除多模态模型配置 model_id={}", model_id)
...
def detect_multimodal_models_route(
    ...
    logger.info("API 请求：探测多模态模型 endpoint_url={}", payload.endpoint_url)
    return ApiResponse(
        code=0,
        message="success",
...
def chat_with_multimodal_model_route(
    ...
    logger.info(
        "API 请求：非流式多模态聊天 model_id={} session_id={} message_count={}",
        model_id,
        payload.session_id,
...
def stream_chat_with_multimodal_model_route(
    ...
    logger.info(
        "API 请求：流式多模态聊天 model_id={} session_id={} message_count={}",
        model_id,
        payload.session_id,
        len(payload.messages),
    )
...
def list_multimodal_chat_sessions_route(
    ...
    logger.info("API 请求：查询多模态聊天会话列表 model_id={}", model_id)
    return ApiResponse(
        code=0,
        message="success",
...
def get_multimodal_chat_session_detail_route(
    ...
    logger.info("API 请求：查询多模态聊天会话详情 session_id={}", session_id)
    return ApiResponse(
        code=0,
        message="success",
...
def delete_multimodal_chat_session_route(
    ...
    logger.info("API 请求：删除多模态聊天会话 session_id={}", session_id)
